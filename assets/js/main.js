...
async function translateText(text) {
  const sourceLang = 'en'; // Idioma de origen (inglés)
...
// Evento click para el botón de traducción
document.getElementById('translate-button').addEventListener('click', async function () {
  const textToTranslate = document.getElementById('translated-text').textContent;
...
function enviarFormulario() {
  var formulario = document.querySelector(".contact__form");
  formulario.submit();
